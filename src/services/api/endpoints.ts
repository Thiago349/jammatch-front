...
export { postAuth, refreshAuth, postLabServiceRandom, getProfile, putProfile, putProfilePhoto, getSpotifySelf, postSpotifyAttachment, postSpotifyAuth, postRoleAttachments, deleteRoleAttachments, getRoles, getUserSelf }