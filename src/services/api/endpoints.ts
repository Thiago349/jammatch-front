...
export { postAuth, refreshAuth, postLabServiceRandom, getProfile, putProfile, putProfilePhoto, getSpotifySelf, postSpotifyAttachment, postSpotifyAuth, postSpotifyPlaylist, postRoleAttachments, deleteRoleAttachments, getRoles, getUserSelf }